...
async function boot() {
  ...
  soundManager.load("leaf", assets.leafSound);
  soundManager.load("hurt", assets.hurtSound);
  soundManager.load("hit", assets.hitSound);
  soundManager.load("jump", assets.jumpSound);
  soundManager.load("music", assets.musicSound);

  // For missing sounds, reuse existing ones
  soundManager.load("die", assets.hurtSound); // reuse hurt for die
  soundManager.load("win", assets.leafSound); // reuse leaf for win
