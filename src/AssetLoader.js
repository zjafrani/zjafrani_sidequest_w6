...
export async function loadAssets(levelPkg, tuningDoc) {
  ...
  // ---- sounds ----
  const leafSound = await loadSoundAsync("assets/sfx/leafCollect.wav");
  const hurtSound = await loadSoundAsync("assets/sfx/receiveDamage.wav");
  const hitSound = await loadSoundAsync("assets/sfx/hitEnemy.wav");
  const jumpSound = await loadSoundAsync("assets/sfx/jump.wav");
  const musicSound = await loadSoundAsync("assets/sfx/music.wav");
